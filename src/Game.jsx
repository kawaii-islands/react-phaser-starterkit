...
// Selectors
import { selectGameZoom, selectGameWidth, selectGameHeight, selectGameLocale, selectGameSetters, selectGameCameraSizeUpdateCallbacks } from './zustand/game/selectGameData';

// Store
import { useGameStore } from './zustand/store';

// Constants
import { TILE_WIDTH, TILE_HEIGHT, DEFAULT_LOCALE, MIN_GAME_WIDTH, GAME_CONTENT_ID, MIN_GAME_HEIGHT, RESIZE_THRESHOLD, RE_RESIZE_THRESHOLD } from './constants';
...
function Game() {
  ...
  const { setGameZoom, setGameWidth, setGameHeight, setGameCanvasElement } = useGameStore(selectGameSetters);
  ...
  }, [game, updateGameGlobalState, cameraSizeUpdateCallbacks]);
